...
const MENU_CATEGORIES = [
  ...
  { value: 'dolci', label: 'Dolci (Desserts)' },
  { value: 'drinks', label: 'Drinks' }
];

const DEFAULT_MENU = [
  { id: 1, name: "Bruschetta", category: "antipasti", price: 12.00, description: "Toasted bread with fresh tomatoes, basil, and balsamic glaze", image: "https://images.unsplash.com/photo-1572695157366-5e585ab2b69f?w=600&q=80" },
  { id: 2, name: "Calamari Fritti", category: "antipasti", price: 14.00, description: "Crispy fried calamari with marinara sauce", image: "https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=600&q=80" },
  { id: 3, name: "Pasta Carbonara", category: "pasta", price: 18.00, description: "Spaghetti with pancetta, egg, pecorino, black pepper", image: "https://images.unsplash.com/photo-1612874742237-6526221588e3?w=600&q=80" },
  { id: 4, name: "Mushroom Risotto", category: "pasta", price: 22.00, description: "Creamy arborio rice with wild mushrooms and parmesan", image: "https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=600&q=80" },
  { id: 5, name: "Margherita Pizza", category: "pizza", price: 16.00, description: "San Marzano tomatoes, fresh mozzarella, basil", image: "https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=600&q=80" },
  { id: 6, name: "Quattro Formaggi", category: "pizza", price: 19.00, description: "Mozzarella, gorgonzola, fontina, parmesan", image: "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=600&q=80" },
  { id: 7, name: "Osso Buco", category: "mains", price: 32.00, description: "Braised veal shank with gremolata and risotto", image: "https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=80" },
  { id: 8, name: "Chicken Parmigiana", category: "mains", price: 24.00, description: "Breaded chicken, marinara, melted mozzarella, spaghetti", image: "https://images.unsplash.com/photo-1632778149955-e80f8ceca2e8?w=600&q=80" },
  { id: 9, name: "Tiramisu", category: "dolci", price: 10.00, description: "Espresso-soaked ladyfingers, mascarpone, cocoa", image: "https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=600&q=80" },
  { id: 10, name: "Panna Cotta", category: "dolci", price: 9.00, description: "Vanilla cream with berry compote", image: "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&q=80" }
];
...
function renderCharts() {
  ...
  let orders = getOrders();
  let burgundy = getComputedStyle(document.documentElement).getPropertyValue('--burgundy').trim() || '#800020';
  let gold = getComputedStyle(document.documentElement).getPropertyValue('--gold').trim() || '#D4AF37';
...
function seedDemoData() {
  ...
  let menuItems = [
    ...
    { name: 'Classic Lasagna', price: 20 },
    { name: 'Mushroom Risotto', price: 22 },
    { name: 'Calamari Fritti', price: 14 },
    { name: 'Caprese Salad', price: 13 }
  ];

  // generate 15 orders spread over last 7 days
  for (let i = 0; i < 15; i++) {
    ...
    demoOrders.push({
      ...
      address: Math.floor(100 + Math.random() * 900) + ' Main St, New York',
      time: d.toISOString()
    });
  }
