...
const MENU_CATEGORIES = [
  ...
  { value: 'wines', label: 'Wines & Drinks' }
];

const DEFAULT_MENU = [
  { id: 1, name: "French Onion Soup", category: "starters", price: 12.00, description: "Classic caramelized onion soup with gruyere crouton", image: "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=600&q=80" },
  { id: 2, name: "Escargot", category: "starters", price: 16.00, description: "Burgundy snails baked with garlic herb butter", image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&q=80" },
  { id: 3, name: "Steak Frites", category: "mains", price: 28.00, description: "Hanger steak, hand-cut fries, cafe de Paris butter", image: "https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=80" },
  { id: 4, name: "Coq au Vin", category: "mains", price: 26.00, description: "Braised chicken in red wine with mushrooms and pearl onions", image: "https://images.unsplash.com/photo-1600891964092-4316c288032e?w=600&q=80" },
  { id: 5, name: "Bouillabaisse", category: "seafood", price: 32.00, description: "Provencal fish stew with mussels, shrimp, and saffron broth", image: "https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?w=600&q=80" },
  { id: 6, name: "Sole Meuniere", category: "seafood", price: 30.00, description: "Pan-fried Dover sole with brown butter and lemon", image: "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=600&q=80" },
  { id: 7, name: "Truffle Fries", category: "sides", price: 10.00, description: "Crispy fries with truffle oil and parmesan", image: "https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=600&q=80" },
  { id: 8, name: "Creme Brulee", category: "desserts", price: 12.00, description: "Classic vanilla custard with caramelized sugar crust", image: "https://images.unsplash.com/photo-1470324161839-ce2bb6fa6bc3?w=600&q=80" },
  { id: 9, name: "Tarte Tatin", category: "desserts", price: 14.00, description: "Upside-down caramelized apple tart with vanilla cream", image: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80" },
  { id: 10, name: "Bordeaux Rouge", category: "wines", price: 14.00, description: "House red wine, smooth with dark fruit notes", image: "https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=600&q=80" }
];
