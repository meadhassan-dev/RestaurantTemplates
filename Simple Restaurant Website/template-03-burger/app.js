...
const DEFAULT_MENU = [
  { id: 1, name: "Classic Smash Burger", category: "burgers", price: 12.99, description: "Double smashed patties, American cheese, pickles, special sauce", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=80" },
  { id: 2, name: "Bacon BBQ Burger", category: "burgers", price: 14.99, description: "Angus beef, crispy bacon, BBQ sauce, onion rings, cheddar", image: "https://images.unsplash.com/photo-1553979459-d2229ba7433b?w=600&q=80" },
  { id: 3, name: "Mushroom Swiss", category: "burgers", price: 13.99, description: "Sauteed mushrooms, Swiss cheese, truffle aioli", image: "https://images.unsplash.com/photo-1572802419224-296b0aeee0d9?w=600&q=80" },
  { id: 4, name: "Crispy Chicken Sandwich", category: "chicken", price: 11.99, description: "Buttermilk fried chicken, coleslaw, pickles on brioche", image: "https://images.unsplash.com/photo-1606755962773-d324e0a13086?w=600&q=80" },
  { id: 5, name: "Loaded Fries", category: "sides", price: 7.99, description: "Crispy fries topped with cheese sauce, bacon, jalapenos", image: "https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=600&q=80" },
  { id: 6, name: "Onion Rings", category: "sides", price: 6.99, description: "Beer-battered thick cut onion rings", image: "https://images.unsplash.com/photo-1639024471283-03518883512d?w=600&q=80" },
  { id: 7, name: "Chocolate Milkshake", category: "shakes", price: 8.99, description: "Hand-spun chocolate shake with whipped cream", image: "https://images.unsplash.com/photo-1572490122747-3968b75cc699?w=600&q=80" },
  { id: 8, name: "Oreo Milkshake", category: "shakes", price: 8.99, description: "Cookies and cream milkshake with Oreo crumbles", image: "https://images.unsplash.com/photo-1579954115545-a95591f28bfc?w=600&q=80" },
  { id: 9, name: "Brownie Sundae", category: "desserts", price: 9.99, description: "Warm chocolate brownie, vanilla ice cream, hot fudge", image: "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=600&q=80" },
  { id: 10, name: "Fresh Lemonade", category: "shakes", price: 4.99, description: "Freshly squeezed lemonade with mint", image: "https://images.unsplash.com/photo-1621263764928-df1444c5e859?w=600&q=80" }
];
