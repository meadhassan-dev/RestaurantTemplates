...
const DEFAULT_MENU = [
  { id: 1, name: "Classic Espresso", category: "coffee", price: 3.99, description: "Rich single-origin espresso shot", image: "https://images.unsplash.com/photo-1510707577719-ae7c14805e3a?w=600&q=80" },
  { id: 2, name: "Caramel Latte", category: "coffee", price: 5.99, description: "Smooth latte with house-made caramel syrup", image: "https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=600&q=80" },
  { id: 3, name: "Cold Brew", category: "coffee", price: 5.49, description: "24-hour steeped cold brew, smooth and bold", image: "https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=600&q=80" },
  { id: 4, name: "Matcha Latte", category: "tea", price: 5.99, description: "Ceremonial grade matcha with oat milk", image: "https://images.unsplash.com/photo-1515823064-d6e0c04616a7?w=600&q=80" },
  { id: 5, name: "Chamomile Tea", category: "tea", price: 3.99, description: "Organic chamomile flowers, honey optional", image: "https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=600&q=80" },
  { id: 6, name: "Butter Croissant", category: "pastries", price: 4.49, description: "Flaky, buttery French croissant", image: "https://images.unsplash.com/photo-1555507036-ab1f4038024a?w=600&q=80" },
  { id: 7, name: "Blueberry Muffin", category: "pastries", price: 4.99, description: "Fresh-baked muffin loaded with blueberries", image: "https://images.unsplash.com/photo-1607920591413-4ec007e70023?w=600&q=80" },
  { id: 8, name: "Avocado Toast", category: "savory", price: 9.99, description: "Sourdough, smashed avocado, poached egg, chili flakes", image: "https://images.unsplash.com/photo-1541519227354-08fa5d50c44d?w=600&q=80" },
  { id: 9, name: "Iced Lemonade", category: "drinks", price: 4.99, description: "Fresh-squeezed lemonade with mint", image: "https://images.unsplash.com/photo-1621263764928-df1444c5e859?w=600&q=80" },
  { id: 10, name: "Tiramisu Cake", category: "desserts", price: 7.99, description: "Espresso-soaked layers with mascarpone cream", image: "https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=600&q=80" }
];
...
function seedDemoData() {
  ...
  let demoOrders = [];
  let names = ['Emma Wilson', 'Liam Brown', 'Olivia Davis', 'Noah Taylor', 'Ava Martinez'];
  let menuItems = [
    { name: 'Classic Espresso', price: 3.99 },
    { name: 'Caramel Latte', price: 5.99 },
    { name: 'Cold Brew', price: 5.49 },
    { name: 'Matcha Latte', price: 5.99 },
    { name: 'Butter Croissant', price: 4.49 },
    { name: 'Avocado Toast', price: 9.99 },
    { name: 'Tiramisu Cake', price: 7.99 },
    { name: 'Iced Lemonade', price: 4.99 }
  ];
  ...
  for (let i = 0; i < 15; i++) {
    ...
    demoOrders.push({
      ...
      phone: '(718) 555-' + Math.floor(1000 + Math.random() * 9000),
      address: Math.floor(100 + Math.random() * 900) + ' Brew St, Brooklyn',
      time: d.toISOString()
    });
  }
