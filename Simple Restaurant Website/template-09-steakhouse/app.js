...
const MENU_CATEGORIES = [
  ...
  { value: 'seafood', label: 'Surf & Turf' },
  { value: 'desserts', label: 'Desserts' },
  { value: 'drinks', label: 'Drinks' }
];

const DEFAULT_MENU = [
  { id: 1, name: "Ribeye 16oz", category: "steaks", price: 48.00, description: "Prime dry-aged ribeye, bone-in, seasoned with sea salt", image: "https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=80" },
  { id: 2, name: "Filet Mignon 10oz", category: "steaks", price: 52.00, description: "Butter-tender center-cut filet, herb crust", image: "https://images.unsplash.com/photo-1558030006-450675393462?w=600&q=80" },
  { id: 3, name: "New York Strip 14oz", category: "steaks", price: 44.00, description: "USDA Prime strip steak, grilled to perfection", image: "https://images.unsplash.com/photo-1600891964092-4316c288032e?w=600&q=80" },
  { id: 4, name: "Tomahawk Ribeye", category: "steaks", price: 72.00, description: "32oz bone-in tomahawk, for the table", image: "https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=80" },
  { id: 5, name: "Shrimp Cocktail", category: "starters", price: 16.00, description: "Jumbo shrimp, house cocktail sauce, lemon", image: "https://images.unsplash.com/photo-1565680018434-b513d5e5fd47?w=600&q=80" },
  { id: 6, name: "Caesar Salad", category: "starters", price: 12.00, description: "Romaine, parmesan, croutons, classic caesar dressing", image: "https://images.unsplash.com/photo-1550304943-4f24f54ddde9?w=600&q=80" },
  { id: 7, name: "Truffle Mac & Cheese", category: "sides", price: 14.00, description: "Three-cheese blend with black truffle oil", image: "https://images.unsplash.com/photo-1543339494-b4cd4f7ba686?w=600&q=80" },
  { id: 8, name: "Loaded Baked Potato", category: "sides", price: 10.00, description: "Sour cream, chives, bacon, cheddar cheese", image: "https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=600&q=80" },
  { id: 9, name: "Lobster Tail", category: "seafood", price: 38.00, description: "8oz cold-water lobster tail with drawn butter", image: "https://images.unsplash.com/photo-1553621042-f6e147245754?w=600&q=80" },
  { id: 10, name: "New York Cheesecake", category: "desserts", price: 12.00, description: "Classic creamy cheesecake with berry compote", image: "https://images.unsplash.com/photo-1533134242443-d4fd215305ad?w=600&q=80" }
];
...
function seedDemoData() {
  ...
  let demoOrders = [];
  let names = ['James Croft', 'Victoria Sterling', 'Michael Hart', 'Elizabeth Moore', 'William Drake'];
  let menuItems = [
    { name: 'Ribeye 16oz', price: 48.00 },
    { name: 'Filet Mignon 10oz', price: 52.00 },
    { name: 'New York Strip 14oz', price: 44.00 },
    { name: 'Tomahawk Ribeye', price: 72.00 },
    { name: 'Lobster Tail', price: 38.00 },
    { name: 'Caesar Salad', price: 12.00 },
    { name: 'Truffle Mac & Cheese', price: 14.00 },
  ...
  for (let i = 0; i < 15; i++) {
    ...
    d.setHours(17 + Math.floor(Math.random() * 5), Math.floor(Math.random() * 60));
    ...
    let total = subtotal + 5.99 + subtotal * 0.08;
    ...
    demoOrders.push({
      ...
      address: Math.floor(100 + Math.random() * 900) + ' Prime Cut Ave, Manhattan',
      time: d.toISOString()
    });
  }
