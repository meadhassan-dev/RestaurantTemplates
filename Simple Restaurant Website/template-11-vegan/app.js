...
const MENU_CATEGORIES = [
  { value: 'bowls', label: 'Power Bowls' },
  { value: 'salads', label: 'Salads' },
  { value: 'mains', label: 'Main Courses' },
  { value: 'smoothies', label: 'Smoothies & Juices' },
  { value: 'desserts', label: 'Desserts' },
  { value: 'drinks', label: 'Drinks' }
];

const DEFAULT_MENU = [
  { id: 1, name: "Buddha Bowl", category: "bowls", price: 14.99, description: "Quinoa, roasted sweet potato, chickpeas, avocado, tahini dressing", image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=600&q=80" },
  { id: 2, name: "Poke Bowl", category: "bowls", price: 15.99, description: "Brown rice, edamame, cucumber, mango, spicy vegan mayo", image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&q=80" },
  { id: 3, name: "Kale Caesar Salad", category: "salads", price: 12.99, description: "Massaged kale, croutons, vegan parmesan, cashew caesar dressing", image: "https://images.unsplash.com/photo-1550304943-4f24f54ddde9?w=600&q=80" },
  { id: 4, name: "Mediterranean Bowl", category: "bowls", price: 14.99, description: "Falafel, hummus, tabbouleh, pickled vegetables, pita", image: "https://images.unsplash.com/photo-1529006557810-274b9b2fc783?w=600&q=80" },
  { id: 5, name: "Mushroom Steak", category: "mains", price: 18.99, description: "Grilled portobello steak with garlic mashed potatoes and greens", image: "https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=80" },
  { id: 6, name: "Cauliflower Wings", category: "mains", price: 13.99, description: "Crispy battered cauliflower with buffalo sauce and ranch", image: "https://images.unsplash.com/photo-1567620832903-9fc6debc209f?w=600&q=80" },
  { id: 7, name: "Green Power Smoothie", category: "smoothies", price: 8.99, description: "Spinach, banana, mango, almond milk, chia seeds", image: "https://images.unsplash.com/photo-1638176066666-ffb2f013c7dd?w=600&q=80" },
  { id: 8, name: "Acai Bowl", category: "bowls", price: 12.99, description: "Acai blend topped with granola, berries, coconut, honey", image: "https://images.unsplash.com/photo-1590301157890-4810ed352733?w=600&q=80" },
  { id: 9, name: "Vegan Brownie", category: "desserts", price: 7.99, description: "Rich chocolate brownie made with avocado", image: "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=600&q=80" },
  { id: 10, name: "Matcha Latte", category: "drinks", price: 5.99, description: "Ceremonial grade matcha with oat milk", image: "https://images.unsplash.com/photo-1515823064-d6e0c04616a7?w=600&q=80" }
];
