...
const MENU_CATEGORIES = [
  ...
  { value: 'wines', label: 'Wines & Cocktails' }
];

const DEFAULT_MENU = [
  { id: 1, name: "Foie Gras Torchon", category: "starters", price: 28.00, description: "Sauternes gelée, brioche toast, fig compote", image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&q=80" },
  { id: 2, name: "Lobster Bisque", category: "starters", price: 18.00, description: "Creamy lobster soup with cognac and chive oil", image: "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=600&q=80" },
  { id: 3, name: "Wagyu Beef Tenderloin", category: "mains", price: 65.00, description: "A5 Wagyu, truffle jus, pommes puree, seasonal vegetables", image: "https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=80" },
  { id: 4, name: "Duck Confit", category: "mains", price: 42.00, description: "Slow-cooked duck leg, lentils, orange glaze", image: "https://images.unsplash.com/photo-1432139555190-58524dae6a55?w=600&q=80" },
  { id: 5, name: "Pan-Seared Sea Bass", category: "seafood", price: 48.00, description: "Chilean sea bass, beurre blanc, asparagus, fingerling potatoes", image: "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=600&q=80" },
  { id: 6, name: "Lobster Thermidor", category: "seafood", price: 72.00, description: "Whole Maine lobster, gruyere crust, creamy sauce", image: "https://images.unsplash.com/photo-1553621042-f6e147245754?w=600&q=80" },
  { id: 7, name: "Creme Brulee", category: "desserts", price: 16.00, description: "Classic vanilla bean custard with caramelized sugar", image: "https://images.unsplash.com/photo-1470324161839-ce2bb6fa6bc3?w=600&q=80" },
  { id: 8, name: "Chocolate Souffle", category: "desserts", price: 18.00, description: "Valrhona chocolate, vanilla ice cream (20 min wait)", image: "https://images.unsplash.com/photo-1541783245831-57d6fb0926d3?w=600&q=80" },
  { id: 9, name: "Chateau Margaux 2015", category: "wines", price: 85.00, description: "Bordeaux red, full-bodied with silky tannins", image: "https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=600&q=80" },
  { id: 10, name: "French 75 Cocktail", category: "wines", price: 19.00, description: "Gin, champagne, lemon juice, simple syrup", image: "https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=600&q=80" }
];
