...
const MENU_CATEGORIES = [
  ...
  { value: 'burritos', label: 'Burritos & Bowls' },
...
const DEFAULT_MENU = [
  { id: 1, name: "Carne Asada Tacos", category: "tacos", price: 13.99, description: "Grilled steak, onion, cilantro, salsa verde on corn tortillas", image: "https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=600&q=80" },
  { id: 2, name: "Al Pastor Tacos", category: "tacos", price: 12.99, description: "Marinated pork, pineapple, onion, cilantro", image: "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=600&q=80" },
  { id: 3, name: "Fish Tacos", category: "tacos", price: 14.99, description: "Beer-battered cod, chipotle mayo, cabbage slaw, lime", image: "https://images.unsplash.com/photo-1512838256197-31498003f2b4?w=600&q=80" },
  { id: 4, name: "Chicken Burrito", category: "burritos", price: 13.99, description: "Grilled chicken, rice, beans, cheese, pico de gallo, guacamole", image: "https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=600&q=80" },
  { id: 5, name: "Loaded Nachos", category: "starters", price: 11.99, description: "Tortilla chips, cheese, jalapenos, sour cream, guacamole", image: "https://images.unsplash.com/photo-1513456852971-30c0b8199d4d?w=600&q=80" },
  { id: 6, name: "Guacamole & Chips", category: "starters", price: 9.99, description: "Fresh made guacamole with warm tortilla chips", image: "https://images.unsplash.com/photo-1541658016709-82535e94bc69?w=600&q=80" },
  { id: 7, name: "Cheese Quesadilla", category: "quesadillas", price: 10.99, description: "Melted oaxaca cheese, flour tortilla, salsa roja", image: "https://images.unsplash.com/photo-1618040996337-56904b7850b9?w=600&q=80" },
  { id: 8, name: "Margarita", category: "drinks", price: 9.99, description: "Classic lime margarita, tequila, triple sec", image: "https://images.unsplash.com/photo-1556855810-ac404aa91e85?w=600&q=80" },
  { id: 9, name: "Horchata", category: "drinks", price: 4.99, description: "Traditional Mexican rice milk drink with cinnamon", image: "https://images.unsplash.com/photo-1541658016709-82535e94bc69?w=600&q=80" },
  { id: 10, name: "Churros", category: "desserts", price: 7.99, description: "Cinnamon sugar churros with chocolate dipping sauce", image: "https://images.unsplash.com/photo-1624371414361-e670edf4e83a?w=600&q=80" }
];
...
function renderCharts() {
  ...
  let primaryColor = styles.getPropertyValue('--coral').trim() || styles.getPropertyValue('--red').trim() || styles.getPropertyValue('--gold').trim() || styles.getPropertyValue('--green').trim() || '#2E8B57';
