...
const MENU_CATEGORIES = [
  ...
  { value: 'soups', label: 'Soups & Dumplings' },
...
const DEFAULT_MENU = [
  { id: 1, name: "Spring Rolls", category: "appetizers", price: 7.99, description: "Crispy vegetable spring rolls with sweet chili sauce", image: "https://images.unsplash.com/photo-1606525437679-058d8dbf5e90?w=600&q=80" },
  { id: 2, name: "Dim Sum Platter", category: "appetizers", price: 12.99, description: "Assorted steamed dumplings and buns", image: "https://images.unsplash.com/photo-1563245372-f21724e3856d?w=600&q=80" },
  { id: 3, name: "Hot and Sour Soup", category: "soups", price: 8.99, description: "Traditional spicy and tangy soup with tofu and mushrooms", image: "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=600&q=80" },
  { id: 4, name: "Kung Pao Chicken", category: "mains", price: 16.99, description: "Diced chicken with peanuts, vegetables, and chili peppers", image: "https://images.unsplash.com/photo-1525755662778-989d0524087e?w=600&q=80" },
  { id: 5, name: "Sweet and Sour Pork", category: "mains", price: 15.99, description: "Crispy pork with bell peppers, pineapple in tangy sauce", image: "https://images.unsplash.com/photo-1563245372-f21724e3856d?w=600&q=80" },
  { id: 6, name: "Peking Duck", category: "mains", price: 35.99, description: "Roasted duck with pancakes, scallions, and hoisin sauce", image: "https://images.unsplash.com/photo-1518492104633-130d0cc84637?w=600&q=80" },
  { id: 7, name: "Chow Mein", category: "noodles", price: 13.99, description: "Stir-fried egg noodles with vegetables and your choice of protein", image: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=600&q=80" },
  { id: 8, name: "Fried Rice", category: "noodles", price: 12.99, description: "Wok-fried rice with egg, vegetables, and soy sauce", image: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=600&q=80" },
  { id: 9, name: "Mango Pudding", category: "desserts", price: 6.99, description: "Creamy mango pudding with coconut cream", image: "https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=600&q=80" },
  { id: 10, name: "Jasmine Tea", category: "drinks", price: 3.99, description: "Fragrant jasmine green tea", image: "https://images.unsplash.com/photo-1556881286-fc6915169721?w=600&q=80" }
];
...
function seedDemoData() {
  ...
  let menuItems = [
    ...
    { name: 'Sweet and Sour Pork', price: 15 },
    { name: 'Dim Sum', price: 12 },
    { name: 'Peking Duck', price: 35 },
    { name: 'Fried Rice', price: 12 },
    { name: 'Hot and Sour Soup', price: 8 },
    { name: 'Wonton Noodles', price: 14 }
  ];
  for (let i = 0; i < 15; i++) {
